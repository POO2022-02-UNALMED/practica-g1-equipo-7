...
ventana_principal.title("Mis reservas")
...
#Letrero
letrero = tk.Label(frame_letrero, text="Mis reservas", font=("verdana", 16, "bold"), fg="white",borderwidth=3, background="#61727C", width=20, height=2)
